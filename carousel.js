    ...
    return {
      tags: item => {
        ...
        tagList.innerHTML = item.tags
          ...
          .join(this.settings.tagsDelimiter === ", " ? " " : this.settings.tagsDelimiter);
      ...
      categories: item => {
        ...
        if (item.categories?.length) {
          categoryList.innerHTML = item.categories
            .map(
              ...
              <li>
                <span class="category" rel="category">${category}${
                  index < array.length - 1 && this.settings.categoriesDelimiter === ", " 
                  ? "," 
                  : ""
                }</span>
              </li>
            ...
            .join(this.settings.categoriesDelimiter === ", " ? " " : this.settings.categoriesDelimiter);
