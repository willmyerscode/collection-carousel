  ...
  static getSwiperConfig(settings, container) {
    ...
    const updateSwiperOffsets = swiper => {
      ...
      if (swiper.el.closest(".fluid-engine")) {
        ...
        const sqsLayout = swiper.el.closest(".sqs-layout");
        tempBlockWidth = sqsLayout.offsetWidth;
      }
    ...
    return {
      ...
      on: {
        setTransition: function (swiper, duration) {
          // Force reset animating property after transition duration when in free mode
          if (settings.freeMode && duration > 0) {
            setTimeout(() => {
        ...
        init: function (swiper) {
          ...
          // to handle  the previous sliding. Code used from https://github.com/nolimits4web/swiper/blob/master/src/core/slide/slidePrev.mjs
      ...
      if (this.settings.metadataAboveTitle.length) {
        ...
        this.settings.metadataAboveTitle.forEach(metadata => {
          if (builders[metadata]) {
            ...
            if (element) {
              if (hasAddedElement && this.settings.metadataDelimiter) {
                const delimiter = document.createElement("span");
                delimiter.className = "metadata-delimiter metadata";
                delimiter.textContent = this.settings.metadataDelimiter;
                metadataAboveTitle.appendChild(delimiter);
              }
          ...
          if (builders[metadata]) {
            ...
            if (element) {
              if (hasAddedElement && this.settings.metadataDelimiter) {
                ...
                delimiter.className = "metadata-delimiter metadata";
                delimiter.textContent = this.settings.metadataDelimiter;
                metadataBelowTitle.appendChild(delimiter);
              }
          ...
          if (builders[metadata]) {
            ...
            if (element) {
              if (hasAddedElement && this.settings.metadataDelimiter) {
                ...
                delimiter.className = "metadata-delimiter metadata";
                delimiter.textContent = this.settings.metadataDelimiter;
                metadataBelowExcerpt.appendChild(delimiter);
              }
              metadataBelowExcerpt.appendChild(element);
              hasAddedElement = true;
            }
          }
        });
    ...
    const getData = async path => {
      try {
        ...
        if (type === "event") {
          ...
          currentItems = [...past.reverse(), ...upcoming];
        }
...
(function () {
  ...
  wmCollectionCarousel.Swiper = (function () {
    "use strict";
    function e(e) {
      return (
        null !== e &&
